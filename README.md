...
详细文档请参阅 [文档中心](docs/README.md)，按维度分类：

- [调研分析](docs/00-调研分析/) — OpenCode 数据资产调研
- [交付定义](docs/01-交付定义/) — 产品需求与版本发布
- [架构设计](docs/02-架构设计/) — 整体架构 / 数据访问层 / 技术栈
- [功能模块](docs/03-功能模块/) — 仪表盘 / 会话 / 消息 / 清理 / 备份
- [技术方案](docs/04-技术方案/) — 特性级技术设计
- [决策记录](docs/05-决策记录/) — ADR 架构决策记录
- [开发贡献](docs/06-开发贡献/) — 环境搭建 / 规范 / 测试 / PR
- [使用手册](docs/07-使用手册/) — 终端用户指南
